...
<body class="easyui-layout" style="overflow: scroll;">
	...
	<div region='west' title='功能菜单' style="width: 200px;">
		...
		<div id="aa" class="easyui-accordion"
			...
			<div title="人事管理" selected="true"
				style="overflow: scroll; padding: 10px; background-color: #F8FAFF">
				<ul class="easyui-tree">
				   <li data-options="attributes:{'url':'userList.jsp'}">查看员工信息</li>
				    
				    <li><span>更新员工信息</span></li>
					<li><span>员工入职</span></li>
					<li><span>员工离职</span></li>
				</div>
			<div title="部门管理" selected="true"
				style="overflow: scroll; padding: 10px; background-color: #F8FAFF">
				<ul class="easyui-tree">
			      <li><span>查看部门信息</span></li>
			      <li><span>修改部门信息</span></li>
			</div>
			<div title="职位管理" selected="true"
				style="overflow: scroll; padding: 10px; background-color: #F8FAFF">
				<ul class="easyui-tree">
			       <li><span>查看职位信息</span></li>
			       <li><span>添加职位</span></li>
			       <li><span>删除职位</span></li>
			       <li><span>修改职位</span></li>
			       <li><span>薪资调整</span></li>
			</div>
	...
	<div data-options="region:'center',title:''" >
    	<div id="tabs" class="easyui-tabs" style="height: 600px" >
		    <div title="首页" style="padding:20px; background-image: url(images/timg.jpg); ">
		        <h1 align="center">欢迎来到玉井湾休闲山庄</h1>
		    </div>
		</div>
    </div>
</body>
